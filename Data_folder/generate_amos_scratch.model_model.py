...
MODEL_NAME = "amos_scratch.model"
MODEL_UID = "ab499702-e87f-46aa-b1d4-59d910eee320"
## END OF CONFIGURATION.

def make_unet():

    ## Configuration. Automatically generated by the model trainer. Do not edit.
    LABELS_DICT = {1: 'aorta', 2: 'bladder', 3: 'duodenum', 4: 'esophagus', 5: 'gallbladder', 6: 'inferior_vena_cava', 7: 'left_adrenal_gland', 8: 'left_kidney', 9: 'liver', 10: 'pancreas', 11: 'portal_splenic_vein', 12: 'right_adrenal_gland', 13: 'right_kidney', 14: 'spleen', 15: 'stomach'}
    MODEL_SIZE = [256, 256]
    N_LEVELS = 5
    N_CONV_LAYERS = 2
