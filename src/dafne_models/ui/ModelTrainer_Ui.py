...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.transfer_learning_checkBox = QtWidgets.QCheckBox(ModelTrainerUI)
        self.transfer_learning_checkBox.setObjectName("transfer_learning_checkBox")
        self.horizontalLayout_6.addWidget(self.transfer_learning_checkBox)
        self.label_6 = QtWidgets.QLabel(ModelTrainerUI)
        self.label_6.setObjectName("label_6")
        self.horizontalLayout_6.addWidget(self.label_6)
        self.BaseModel_Text = QtWidgets.QLineEdit(ModelTrainerUI)
        ...
        self.pushButton = QtWidgets.QPushButton(ModelTrainerUI)
        ...
        self.trainableLayersButton = QtWidgets.QPushButton(ModelTrainerUI)
        self.trainableLayersButton.setEnabled(False)
        self.trainableLayersButton.setObjectName("trainableLayersButton")
        self.horizontalLayout_7.addWidget(self.trainableLayersButton)
        self.layerLabel = QtWidgets.QLabel(ModelTrainerUI)
        self.layerLabel.setEnabled(False)
        self.layerLabel.setObjectName("layerLabel")
        self.horizontalLayout_7.addWidget(self.layerLabel)
        self.spinBox = QtWidgets.QSpinBox(ModelTrainerUI)
        self.spinBox.setEnabled(False)
        self.spinBox.setAlignment(QtCore.Qt.AlignCenter)
        self.spinBox.setMinimum(1)
        self.spinBox.setMaximum(116)
    ...
    def retranslateUi(self, ModelTrainerUI):
        ...
        self.transfer_learning_checkBox.setText(_translate("ModelTrainerUI", "Enable Transfer Learning"))
        self.label_6.setText(_translate("ModelTrainerUI", "Base model:"))
        self.pushButton.setText(_translate("ModelTrainerUI", "Choose..."))
        self.trainableLayersButton.setText(_translate("ModelTrainerUI", "Set Trainable Layers "))
        self.layerLabel.setText(_translate("ModelTrainerUI", "Selected layers"))
        ...
        self.progress_Label.setText(_translate("ModelTrainerUI", "TextLabel"))
