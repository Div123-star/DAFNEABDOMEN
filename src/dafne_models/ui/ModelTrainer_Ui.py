...
class Ui_ModelTrainerUI(object):
    def setupUi(self, ModelTrainerUI):
        ...
        self.selected_layers_Label = QtWidgets.QLabel(self.transfer_learning_checkBox)
        self.selected_layers_Label.setEnabled(False)
        self.selected_layers_Label.setObjectName("selected_layers_Label")
        self.horizontalLayout_7.addWidget(self.selected_layers_Label)
        self.num_trainable_layers_spinBox = QtWidgets.QSpinBox(self.transfer_learning_checkBox)
        self.num_trainable_layers_spinBox.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.num_trainable_layers_spinBox.sizePolicy().hasHeightForWidth())
        self.num_trainable_layers_spinBox.setSizePolicy(sizePolicy)
        self.num_trainable_layers_spinBox.setAlignment(QtCore.Qt.AlignCenter)
        self.num_trainable_layers_spinBox.setMinimum(1)
        self.num_trainable_layers_spinBox.setMaximum(116)
        self.num_trainable_layers_spinBox.setSingleStep(1)
        self.num_trainable_layers_spinBox.setProperty("value", 3)
        self.num_trainable_layers_spinBox.setObjectName("num_trainable_layers_spinBox")
        self.horizontalLayout_7.addWidget(self.num_trainable_layers_spinBox)
    ...
    def retranslateUi(self, ModelTrainerUI):
        ...
        self.selected_layers_Label.setText(_translate("ModelTrainerUI", "Trainable layers: "))
